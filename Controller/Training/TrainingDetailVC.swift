...
class TrainingDetailVC: ButtonBarPagerTabStripViewController {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        let child_1 = UIStoryboard(name: "Training", bundle: nil).instantiateViewController(withIdentifier: "TrainingOverViewVC") as! TrainingOverViewVC
        child_1.Cources_ID = self.Course_ID
        let child_2 =  UIStoryboard(name: "Training", bundle: nil).instantiateViewController(withIdentifier: "TrainingRatingVC") as! TrainingRatingVC
        child_2.Course_ID = self.Course_ID
        guard isReload else {
            return [child_1,
                    child_2]
        }
